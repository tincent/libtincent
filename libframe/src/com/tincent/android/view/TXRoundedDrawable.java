...
public class TXRoundedDrawable extends Drawable {
	...
	public TXRoundedDrawable(Bitmap bitmap) {
		mBitmap = bitmap;
	...
	public static TXRoundedDrawable fromBitmap(Bitmap bitmap) {
		if (bitmap != null) {
			return new TXRoundedDrawable(bitmap);
		} else {
			return null;
		}
	}
	...
	public static Drawable fromDrawable(Drawable drawable) {
		if (drawable != null) {
			...
			if (bm != null) {
				return new TXRoundedDrawable(bm);
			} else {
	...
	public TXRoundedDrawable setCornerRadius(float radius) {
	...
	public TXRoundedDrawable setBorderWidth(float width) {
		mBorderWidth = width;
		mBorderPaint.setStrokeWidth(mBorderWidth);
		return this;
	}
	...
	public TXRoundedDrawable setBorderColor(int color) {
	...
	public TXRoundedDrawable setBorderColor(ColorStateList colors) {
	...
	public TXRoundedDrawable setOval(boolean oval) {
		mOval = oval;
		return this;
	}
	...
	public TXRoundedDrawable setScaleType(ScaleType scaleType) {
		if (scaleType == null) {
	...
	public TXRoundedDrawable setTileModeX(Shader.TileMode tileModeX) {
	...
	public TXRoundedDrawable setTileModeY(Shader.TileMode tileModeY) {

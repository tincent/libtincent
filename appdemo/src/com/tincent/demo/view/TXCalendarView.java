...
public class TXCalendarView extends View implements View.OnTouchListener {
	private final static String TAG = "anCalendar";
	private Date selectedStartDate;
	private Date selectedEndDate;
	private Date curDate =selectedStartDate = selectedEndDate = today = new Date(); // 当前日历显示的月
	...
	public TXCalendarView(Context context) {
		super(context);
		init();
	}

	public TXCalendarView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
...
//		}
	...
	public void setData(Date date){
		...
		curDate = selectedStartDate = selectedEndDate = today = date;
...
//		}
			...
			if (downDate != null) {
				if(isSelectMore){
					if (!completed) {
						...
						completed = true;
						//响应监听事件
						OnDateChangeListener.onSelectedDayChange(selectedStartDate,selectedEndDate,downDate);
					} else {
	...
	public interface OnDateChangeListener {
		void onSelectedDayChange(Date selectedStartDate,Date selectedEndDate, Date downDate);
	}
...
//		public int cellSelectedColor = R.drawable.cellselectdate_bg;

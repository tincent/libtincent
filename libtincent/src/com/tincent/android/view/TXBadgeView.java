...
/**
 * 听讯科技：气泡文本类，类似微信朋友圈的气泡消息提醒
 * 
 * @author hui.wang
 * @date 2015.3.16
 * 
 */
public class TXBadgeView extends TextView {
	...
	public TXBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}

	public TXBadgeView(Context context, AttributeSet attrs) {
	 ...
	 */
	public TXBadgeView(Context context, View target) {
	 ...
	 */
	public TXBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public TXBadgeView(Context context, AttributeSet attrs, int defStyle) {
